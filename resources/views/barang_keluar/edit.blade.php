        ...
        <div class="form-group row">
            <div class="col-md-5">
                ...
                <select style="width:100%" name="barang_id" id="barang" class="form-control select" required>
                    <option value="{{$barang_keluar->barang->id}}">{{$barang_keluar->barang->nama_barang}}</option>
                    @foreach ($barang as $b)
            ...
            <div class="col-md-5">
                ...
                <input id="jumlah_barang" type="text" name="jumlah" class="form-control" required value="{{$barang_keluar->jumlah}}">
            </div>
        </div>
